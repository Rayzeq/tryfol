...
trait StatusNotifierWatcher {
    ...
    fn register_status_notifier_host(&self, service: BusName<'_>) -> zbus::fdo::Result<()>;
    ...
    fn register_status_notifier_item(&self, service: BusName<'_>) -> zbus::fdo::Result<()>;
    ...
    #[zbus(signal)]
    fn status_notifier_host_registered(&self) -> zbus::fdo::Result<()>;
    ...
    #[zbus(signal)]
    fn status_notifier_host_unregistered(&self) -> zbus::fdo::Result<()>;
    ...
    #[zbus(signal)]
    fn status_notifier_item_registered(&self, service: &str) -> zbus::fdo::Result<()>;
    ...
    /// when they should update their representation of the items.
    #[zbus(signal)]
    fn status_notifier_item_unregistered(&self, service: &str) -> zbus::fdo::Result<()>;
}
